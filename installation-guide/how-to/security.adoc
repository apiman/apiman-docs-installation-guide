...
Finally, if you are using a standalone gateway, you should also configure the link:../gateway/security.adoc#_setup[Gateway API] to point to the same Keycloak instance.
