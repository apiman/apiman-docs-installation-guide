...
* http://download.jboss.org/wildfly/10.1.0.Final/{wildfly-version}.zip[Download WildFly]
...
----
curl http://download.jboss.org/wildfly/{wildfly-version}/wildfly-{wildfly-version}.zip -o wildfly-{wildfly-version}.zip

curl https://github.com/apiman/apiman/releases/download/{apiman-version-release}/apiman-distro-wildfly-{apiman-version-release}-overlay.zip
----
