...
:servlet-mgr: xref:servlet/install.adoc
:vertx-gw: xref:vertx/download.adoc
...
. Select and download a {servlet-mgr}[Servlet all-in-one distro] of Apiman (e.g. WildFly, Tomcat).
